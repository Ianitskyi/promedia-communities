...
⚠️ **Потребують ручної звірки з оригіналом**: «Доступ Медіа» (одне з джерел
помилково прив'язувало видання до Кривого Рогу замість Кропивницького — місто
навмисно не вказано в описі), «Перший Криворізький» (опис спирається на
вторинні джерела — Facebook, немає прямої сторінки «Про нас» на сайті).
...
| 5 | [Доступ Медіа](https://dostyp.com.ua/) | Кропивницький | https://dostyp.com.ua/ | ✅⚠️ | ❌ | рек. | ❌ |
